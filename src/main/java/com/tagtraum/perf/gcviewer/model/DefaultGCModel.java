 ...
 */
public class DefaultGCModel implements Serializable, GCModel {
    ...
    private static final Logger LOG = Logger.getLogger(DefaultGCModel.class.getName());
